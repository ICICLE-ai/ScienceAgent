...
class ScienceAgent():
    def __init__(self, llm_engine_name, cache_dir=".cache/", n_gpus=0, context_cutoff=28000, use_self_debug=False, use_ll_plan=False, use_knowledge=False):
        self.llm_engine = LLMEngine(llm_engine_name, cache_dir, n_gpus)
        self.llm_cost = model_cost[llm_engine_name]

        self.context_cutoff = context_cutoff
        self.use_self_debug = use_self_debug
        self.use_ll_plan = use_ll_plan
